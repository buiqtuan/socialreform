/**
 * Social Authentication Utilities (Shared)
 * 
 * Helper functions and types for social authentication integration
 * This file can be used in both frontend and backend applications
 */
...
export function getSocialAuthEndpoint(platform: SocialPlatform, baseUrl?: string): string {
...
export async function socialLogin(
  ...
  try {
    const endpoint = getSocialAuthEndpoint(platform, baseUrl)
